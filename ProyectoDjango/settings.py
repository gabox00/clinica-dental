...
SECRET_KEY = '*hfbn#*+$1fne*0@1_2k*+o5b^kz9o$z@+15)zy1j6v!(!m=!+'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'citas.processor.getCitas',
                'citas.processor.getTypesOf',
                'citas.processor.getEmployees',
            ],
            'libraries': {
                'filters_tag': 'pages.templatetags.filters',
            },
        },
    },
]
